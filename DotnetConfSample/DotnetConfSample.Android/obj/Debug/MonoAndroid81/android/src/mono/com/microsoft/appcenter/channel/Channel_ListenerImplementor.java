...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_onPreparedLog:(Lcom/microsoft/appcenter/ingestion/models/Log;Ljava/lang/String;)V:GetOnPreparedLog_Lcom_microsoft_appcenter_ingestion_models_Log_Ljava_lang_String_Handler:Com.Microsoft.Appcenter.Channel.IChannelListenerInvoker, Microsoft.AppCenter.Android.Bindings\n" +
	...
	public void onGroupAdded (java.lang.String p0, com.microsoft.appcenter.channel.Channel.GroupListener p1)
	{
		n_onGroupAdded (p0, p1);
	}

	private native void n_onGroupAdded (java.lang.String p0, com.microsoft.appcenter.channel.Channel.GroupListener p1);
	...
	public void onPreparedLog (com.microsoft.appcenter.ingestion.models.Log p0, java.lang.String p1)
	{
		n_onPreparedLog (p0, p1);
	}

	private native void n_onPreparedLog (com.microsoft.appcenter.ingestion.models.Log p0, java.lang.String p1);
